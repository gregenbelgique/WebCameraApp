...
captureButton.addEventListener('click', async () => {
    ...
    try {
        ...
        statusMessage.textContent = "Envoi de l'image à l'OCR (Google Vision)..."; // Ce message est maintenant supprimé par le style
...
async function performOcr(imageDataUrl) {
    try { 
        ...
        statusMessage.textContent = `OCR terminé. Texte reconnu.`; // Ce message est maintenant supprimé par le style
        return ocrResult;
    } catch (ocrError) {
